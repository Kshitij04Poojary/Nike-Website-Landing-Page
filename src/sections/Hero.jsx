...
const Hero = () => {
  ...
  return (
    <section 
    id="home"
    className="w-full flex x1:flex-row 
    ...
    gap-10 max-container">
      ...
      max-sm:leading-[82] font-bold">
        ...
        relative z-10 pr-10">The New Arrival
        </span><br/>
      ...
      text-lg leading-8
      mt-6 mb-14 sm:max-w-sm">Discover stylish Nike arrivals, quality comfort, and innovation for your active life
      </p>
    ...
    max-xl:py-40
     bg-primary bg-hero bg-cover bg-center">
      ...
      alt="shoe collection"
      width={610}
      height={502} className="object-contain
      relative z-10"/>
